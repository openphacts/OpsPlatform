...
/**
 * <p>Generated LarKC plug-in skeleton for <code>eu.ops.plugin.edffilter.EDFFilter</code>.
 * Use this class as an entry point for your plug-in development.</p>
 */
public class EDFFilter extends Plugin
{
	 ...
	 */
	public EDFFilter(URI pluginUri) {
		super(pluginUri);
	...
	protected void initialiseInternal(SetOfStatements workflowDescription) {
		// TODO Auto-generated method stub
		logger.info("EDFFilter initialized. Hello World!");
	}
