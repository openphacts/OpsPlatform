...
ALTER TABLE application_modules ALTER COLUMN id SET DEFAULT nextval('application_modules_id_seq'::regclass);
...
ALTER TABLE application_types ALTER COLUMN id SET DEFAULT nextval('application_types_id_seq'::regclass);
